...
Tres puntos, siete proyectos, **90 tests de CRUD** más los de JUnit.
...
| **3** | CRUD con TDD en tres lenguajes (ni Java ni Kotlin; uno con framework de front) | [`PracticeOne/crud-tdd`](PracticeOne/crud-tdd) | C#, Python, React, **PHP**, **Rust** |

El punto 3 pedía tres lenguajes: los tres obligatorios son **C#**, **Python** y **TypeScript/React**
(este último cubre el requisito de framework de front). **PHP** y **Rust** se sumaron como extensión.
...
# 2. Instalar dependencias de los cinco proyectos
.\scripts\preparar-entorno.ps1

# 3. Correr las cinco suítes de CRUD
...
└── PracticeOne/
    ├── GUIA-EXPOSICION.md          # guion de la presentación
